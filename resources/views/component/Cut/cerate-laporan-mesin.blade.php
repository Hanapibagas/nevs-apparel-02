...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tables /</span> Input data laporan Cut
    </h4>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <form id="submissionForm" action="{{ route('putLaporanCut', $dataMasuk->id) }}" method="POST"
                        ...
                        <a href="{{ route('getindexDataMasukCut') }}" class="btn btn-outline-secondary"><i
