...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tables /</span> Input data laporan Finish
    </h4>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <form id="submissionForm" action="{{ route('putLaporanFinis', $dataMasuk->id) }}" method="POST"
                        ...
                        <a href="{{ route('getIndexFinis') }}" id="submitButton" class="btn btn-outline-secondary"><i
