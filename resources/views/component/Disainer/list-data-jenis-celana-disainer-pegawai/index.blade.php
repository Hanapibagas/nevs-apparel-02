...
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tables /</span> Jenis celana</h4>
        <button style="margin-bottom: 20px;" type="button" class="btn btn-primary" data-bs-toggle="modal"
            data-bs-target="#modalCenter">
            Tambah data jenis celana
        </button>
        <div class="modal fade" id="modalCenter" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('getCreateistDataJenisCelana') }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                            <div class="row">
                                <div class="col mb-3">
                                    <label for="nameWithTitle" class="form-label">Nama jenis celana</label>
                            ...
                            <div class="row">
                                <div class="col mb-3">
                                    <label for="nameWithTitle" class="form-label">file jenis celana</label>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button data-bs-toggle="modal" data-bs-target="#modalCenter{{ $jenisKerahs->id }}"
                                        ...
                                        Edit</button>
                                    {{-- <form method="POST"
                                        action="{{ route('deleteListDataJenisCelana', ['id' => $jenisKerahs->id]) }}">
                                        @csrf
                                        @method('DELETE')
                            ...
                            <div class="modal fade" id="modalCenter{{ $jenisKerahs->id }}" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('putListDataJenisCelana', $jenisKerahs->id) }}"
