...
@push('js')
<script>
    // Ambil elemen input password dan password_user
    var passwordInput = document.getElementById("password");
    var passwordUserInput = document.getElementById("password_user");

    // Tambahkan event listener untuk memantau perubahan pada input password
    passwordInput.addEventListener("input", function() {
        // Salin nilai dari input password ke input password_user
        passwordUserInput.value = passwordInput.value;
    });
</script>
